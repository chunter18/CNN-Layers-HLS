...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { out_image_V_address0 { O 10 vector } out_image_V_ce0 { O 1 bit } out_image_V_we0 { O 1 bit } out_image_V_d0 { O 18 vector } out_image_V_address1 { O 10 vector } out_image_V_ce1 { O 1 bit } out_image_V_we1 { O 1 bit } out_image_V_d1 { O 18 vector } } \
} "
} else {
