...
set C_modelArgList {
	...
	{ out_image_V int 18 regular {array 900 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ out_image_V_address1 sc_out sc_lv 10 signal 1 } 
	{ out_image_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ out_image_V_we1 sc_out sc_logic 1 signal 1 } 
	{ out_image_V_d1 sc_out sc_lv 18 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_image_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "out_image_V", "role": "address1" }} , 
 	...
 	{ "name": "out_image_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "out_image_V", "role": "d1" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2470", "Max" : "2470"}
	, {"Name" : "Interval", "Min" : "2470", "Max" : "2470"}
]}
...
set Spec2ImplPortList { 
	...
	out_image_V { ap_memory {  { out_image_V_address0 mem_address 1 10 }  { out_image_V_ce0 mem_ce 1 1 }  { out_image_V_we0 mem_we 1 1 }  { out_image_V_d0 mem_din 1 18 }  { out_image_V_address1 mem_address 1 10 }  { out_image_V_ce1 mem_ce 1 1 }  { out_image_V_we1 mem_we 1 1 }  { out_image_V_d1 mem_din 1 18 } } }
}
