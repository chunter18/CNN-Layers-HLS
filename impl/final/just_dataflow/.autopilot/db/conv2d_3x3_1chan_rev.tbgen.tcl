...
set C_modelArgList {
	{ in_image_V int 18 regular {array 7056 { 1 3 } 1 1 }  }
	{ kernel_V int 18 regular {array 9 { 1 3 } 1 1 }  }
	{ bias_V int 48 regular {fifo 0}  }
	{ out_image_V int 25 regular {array 784 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ in_image_V_address0 sc_out sc_lv 13 signal 0 } 
	{ in_image_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ in_image_V_q0 sc_in sc_lv 18 signal 0 } 
	{ kernel_V_address0 sc_out sc_lv 4 signal 1 } 
	{ kernel_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ kernel_V_q0 sc_in sc_lv 18 signal 1 } 
	{ bias_V_dout sc_in sc_lv 48 signal 2 } 
	{ bias_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ bias_V_read sc_out sc_logic 1 signal 2 } 
	...
	{ out_image_V_d0 sc_out sc_lv 25 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_image_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "in_image_V", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.CNN_mul_mul_18s_1cud_U16", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "43905", "Max" : "43905"}
	, {"Name" : "Interval", "Min" : "43905", "Max" : "43905"}
]}
...
set Spec2ImplPortList { 
	in_image_V { ap_memory {  { in_image_V_address0 mem_address 1 13 }  { in_image_V_ce0 mem_ce 1 1 }  { in_image_V_q0 mem_dout 0 18 } } }
	kernel_V { ap_memory {  { kernel_V_address0 mem_address 1 4 }  { kernel_V_ce0 mem_ce 1 1 }  { kernel_V_q0 mem_dout 0 18 } } }
	bias_V { ap_fifo {  { bias_V_dout fifo_data 0 48 }  { bias_V_empty_n fifo_status 0 1 }  { bias_V_read fifo_update 1 1 } } }
	out_image_V { ap_memory {  { out_image_V_address0 mem_address 1 10 }  { out_image_V_ce0 mem_ce 1 1 }  { out_image_V_we0 mem_we 1 1 }  { out_image_V_d0 mem_din 1 25 } } }
}
