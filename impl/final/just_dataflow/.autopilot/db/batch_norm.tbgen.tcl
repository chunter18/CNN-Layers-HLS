...
set C_modelArgList {
	{ in_image_V int 25 regular {array 784 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ A_V_dout sc_in sc_lv 18 signal 1 } 
	{ A_V_empty_n sc_in sc_logic 1 signal 1 } 
	{ A_V_read sc_out sc_logic 1 signal 1 } 
	{ B_V_dout sc_in sc_lv 18 signal 2 } 
	{ B_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ B_V_read sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.CNN_mac_muladd_25dEe_U22", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	in_image_V { ap_memory {  { in_image_V_address0 mem_address 1 10 }  { in_image_V_ce0 mem_ce 1 1 }  { in_image_V_q0 mem_dout 0 25 } } }
