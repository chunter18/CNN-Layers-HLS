...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { out_image_V_address0 { O 8 vector } out_image_V_ce0 { O 1 bit } out_image_V_we0 { O 1 bit } out_image_V_d0 { O 25 vector } out_image_V_address1 { O 8 vector } out_image_V_ce1 { O 1 bit } out_image_V_we1 { O 1 bit } out_image_V_d1 { O 25 vector } } \
} "
} else {
