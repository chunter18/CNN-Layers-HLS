...
#ifndef __CNN_mul_mul_25s_1fYi__HH__
#define __CNN_mul_mul_25s_1fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(CNN_mul_mul_25s_1fYi) {
    ...
    SC_CTOR(CNN_mul_mul_25s_1fYi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
