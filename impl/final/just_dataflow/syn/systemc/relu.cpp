...
relu::relu(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_32_cast_fu_145_p1 );
    ...
    SC_METHOD(thread_k_4_fu_130_p2);
    sensitive << ( k_reg_71 );

    SC_METHOD(thread_p_shl1_cast_fu_114_p1);
    sensitive << ( tmp_28_fu_106_p3 );

    SC_METHOD(thread_p_shl_cast_fu_102_p1);
    sensitive << ( tmp_27_fu_94_p3 );

    SC_METHOD(thread_tmp_21_fu_124_p2);
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( k_reg_71 );

    SC_METHOD(thread_tmp_22_cast_fu_136_p1);
    sensitive << ( k_reg_71 );

    SC_METHOD(thread_tmp_23_fu_150_p2);
    sensitive << ( in_features_V_load_reg_194 );
    sensitive << ( ap_CS_fsm_state5 );

    SC_METHOD(thread_tmp_27_fu_94_p3);
    sensitive << ( j_reg_60 );

    SC_METHOD(thread_tmp_28_fu_106_p3);
    sensitive << ( j_reg_60 );
    ...
    SC_METHOD(thread_tmp_30_fu_140_p2);
    sensitive << ( tmp_29_reg_171 );
    sensitive << ( tmp_22_cast_fu_136_p1 );

    SC_METHOD(thread_tmp_32_cast_fu_145_p1);
    sensitive << ( tmp_30_fu_140_p2 );
    ...
    sc_trace(mVcdFile, tmp_29_reg_171, "tmp_29_reg_171");
    sc_trace(mVcdFile, tmp_fu_82_p2, "tmp_fu_82_p2");
    sc_trace(mVcdFile, k_4_fu_130_p2, "k_4_fu_130_p2");
    sc_trace(mVcdFile, k_4_reg_179, "k_4_reg_179");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, tmp_32_cast_fu_145_p1, "tmp_32_cast_fu_145_p1");
    sc_trace(mVcdFile, tmp_32_cast_reg_184, "tmp_32_cast_reg_184");
    sc_trace(mVcdFile, tmp_21_fu_124_p2, "tmp_21_fu_124_p2");
    ...
    sc_trace(mVcdFile, tmp_27_fu_94_p3, "tmp_27_fu_94_p3");
    sc_trace(mVcdFile, tmp_28_fu_106_p3, "tmp_28_fu_106_p3");
    sc_trace(mVcdFile, p_shl_cast_fu_102_p1, "p_shl_cast_fu_102_p1");
    sc_trace(mVcdFile, p_shl1_cast_fu_114_p1, "p_shl1_cast_fu_114_p1");
    sc_trace(mVcdFile, tmp_22_cast_fu_136_p1, "tmp_22_cast_fu_136_p1");
    sc_trace(mVcdFile, tmp_30_fu_140_p2, "tmp_30_fu_140_p2");
    sc_trace(mVcdFile, tmp_23_fu_150_p2, "tmp_23_fu_150_p2");
...
void relu::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(tmp_21_fu_124_p2.read(), ap_const_lv1_1) && 
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        k_4_reg_179 = k_4_fu_130_p2.read();
    }
    if ((esl_seteq<1,1,1>(tmp_fu_82_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        tmp_29_reg_171 = tmp_29_fu_118_p2.read();
    }
    if ((esl_seteq<1,1,1>(tmp_21_fu_124_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
        tmp_32_cast_reg_184 = tmp_32_cast_fu_145_p1.read();
    }
}

void relu::thread_activations_V_address0() {
    activations_V_address0 =  (sc_lv<10>) (tmp_32_cast_reg_184.read());
}
...
void relu::thread_activations_V_d0() {
    activations_V_d0 = (!tmp_23_fu_150_p2.read()[0].is_01())? sc_lv<48>(): ((tmp_23_fu_150_p2.read()[0].to_bool())? in_features_V_load_reg_194.read(): ap_const_lv48_0);
}
...
void relu::thread_in_features_V_address0() {
    in_features_V_address0 =  (sc_lv<10>) (tmp_32_cast_fu_145_p1.read());
}
...
void relu::thread_k_4_fu_130_p2() {
    k_4_fu_130_p2 = (!k_reg_71.read().is_01() || !ap_const_lv5_1.is_01())? sc_lv<5>(): (sc_biguint<5>(k_reg_71.read()) + sc_biguint<5>(ap_const_lv5_1));
}

void relu::thread_p_shl1_cast_fu_114_p1() {
    p_shl1_cast_fu_114_p1 = esl_zext<11,7>(tmp_28_fu_106_p3.read());
}

void relu::thread_p_shl_cast_fu_102_p1() {
    p_shl_cast_fu_102_p1 = esl_zext<11,10>(tmp_27_fu_94_p3.read());
}

void relu::thread_tmp_21_fu_124_p2() {
    tmp_21_fu_124_p2 = (!k_reg_71.read().is_01() || !ap_const_lv5_1C.is_01())? sc_lv<1>(): sc_lv<1>(k_reg_71.read() == ap_const_lv5_1C);
}

void relu::thread_tmp_22_cast_fu_136_p1() {
    tmp_22_cast_fu_136_p1 = esl_zext<11,5>(k_reg_71.read());
}

void relu::thread_tmp_23_fu_150_p2() {
    tmp_23_fu_150_p2 = (!in_features_V_load_reg_194.read().is_01() || !ap_const_lv48_0.is_01())? sc_lv<1>(): (sc_bigint<48>(in_features_V_load_reg_194.read()) > sc_bigint<48>(ap_const_lv48_0));
}

void relu::thread_tmp_27_fu_94_p3() {
    tmp_27_fu_94_p3 = esl_concat<5,5>(j_reg_60.read(), ap_const_lv5_0);
}

void relu::thread_tmp_28_fu_106_p3() {
    tmp_28_fu_106_p3 = esl_concat<5,2>(j_reg_60.read(), ap_const_lv2_0);
}

void relu::thread_tmp_29_fu_118_p2() {
    tmp_29_fu_118_p2 = (!p_shl_cast_fu_102_p1.read().is_01() || !p_shl1_cast_fu_114_p1.read().is_01())? sc_lv<11>(): (sc_biguint<11>(p_shl_cast_fu_102_p1.read()) - sc_biguint<11>(p_shl1_cast_fu_114_p1.read()));
}

void relu::thread_tmp_30_fu_140_p2() {
    tmp_30_fu_140_p2 = (!tmp_29_reg_171.read().is_01() || !tmp_22_cast_fu_136_p1.read().is_01())? sc_lv<11>(): (sc_biguint<11>(tmp_29_reg_171.read()) + sc_biguint<11>(tmp_22_cast_fu_136_p1.read()));
}

void relu::thread_tmp_32_cast_fu_145_p1() {
    tmp_32_cast_fu_145_p1 = esl_sext<64,11>(tmp_30_fu_140_p2.read());
}
...
void relu::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(tmp_21_fu_124_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
                ap_NS_fsm = ap_ST_fsm_state2;
            } else {
