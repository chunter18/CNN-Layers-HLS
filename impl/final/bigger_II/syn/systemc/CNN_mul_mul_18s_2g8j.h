...
#ifndef __CNN_mul_mul_18s_2g8j__HH__
#define __CNN_mul_mul_18s_2g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(CNN_mul_mul_18s_2g8j) {
    ...
    SC_CTOR(CNN_mul_mul_18s_2g8j):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
