...
void CNN_batchnorm_V::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void CNN_batchnorm_V::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void CNN_batchnorm_V::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void CNN_batchnorm_V::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
